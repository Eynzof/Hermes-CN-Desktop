> 来源：[CodeBuddy 官方文档](https://www.codebuddy.cn/docs/workbuddy/From-Beginner-to-Expert-Guide/Practice-Cases/Practice-One)
...
> 涉及读取或改写本地文件的操作，建议先了解 [两个权限模式](../Function-Description/Permission-Modes.md)，默认权限模式下会在高风险动作前请你确认，更安心。
...
![批量重命名](https://www.codebuddy.cn/docs/static/image-39.CLz1HeVH.png)

你「确认执行」后，WorkBuddy 才会真正改名，并告知完成数量与跳过的文件。

![批量重命名任务返回](https://www.codebuddy.cn/docs/static/image-40.C9A-_X7x.png)
...
![会议纪要](https://www.codebuddy.cn/docs/static/image-41.CPTEr9J1.png)
...
![翻译视频](https://www.codebuddy.cn/docs/static/image-42.2DgIBQgG.png)
