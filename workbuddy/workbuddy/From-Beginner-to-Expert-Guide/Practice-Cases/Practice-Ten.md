> 来源：[CodeBuddy 官方文档](https://www.codebuddy.cn/docs/workbuddy/From-Beginner-to-Expert-Guide/Practice-Cases/Practice-Ten)
...
![](https://www.codebuddy.cn/docs/static/image-38.BKtneyC2.png)
...
![](https://www.codebuddy.cn/docs/static/image-16.BlW2baVu.png)

登录后，参考页面中的"WorkBuddy 原生接入流程"，按步骤完成授权与配置。

![](https://www.codebuddy.cn/docs/static/image-17.CmUaAgh8.png)
...
![](https://www.codebuddy.cn/docs/static/image-18.BPXz_56d.png)

安装过程中，`WorkBuddy` 会自动创建任务，并完成下载、解析和配置等步骤。

![](https://www.codebuddy.cn/docs/static/image-19.DxQg4vfa.png)

安装完成后，可在已安装技能列表中看到腾讯会议 `Skill`。

![](https://www.codebuddy.cn/docs/static/image-20.TU0BBeI2.png)
...
![](https://www.codebuddy.cn/docs/static/image-21.C3B_hT2W.png)

#### b）示例 2

针对会议进行会后总结，如下图所示：

![](https://www.codebuddy.cn/docs/static/image-22.C1ZCX2NY.png)
