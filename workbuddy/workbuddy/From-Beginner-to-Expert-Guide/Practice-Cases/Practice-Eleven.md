> 来源：[CodeBuddy 官方文档](https://www.codebuddy.cn/docs/workbuddy/From-Beginner-to-Expert-Guide/Practice-Cases/Practice-Eleven)
...
![](https://www.codebuddy.cn/docs/static/image-37.BIl-xrRd.png)

## 四、获取并安装腾讯文档相关能力

### 在连接器中配置腾讯文档

参考[腾讯文档](../Function-Description/Knowledge-Base/Tencent-Doc.md)完成连接。
...
![](https://www.codebuddy.cn/docs/static/image-28.WCt7dgd1.png)

#### b）示例 2

针对文档进行修改，如下图所示：

![](https://www.codebuddy.cn/docs/static/image-29.D7nQ2MZE.png)
