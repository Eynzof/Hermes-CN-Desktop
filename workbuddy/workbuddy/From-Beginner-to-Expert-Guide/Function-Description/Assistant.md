> 来源：[CodeBuddy 官方文档](https://www.codebuddy.cn/docs/workbuddy/From-Beginner-to-Expert-Guide/Function-Description/Assistant)
...
![](https://www.codebuddy.cn/docs/static/assistant-3.Btuye0hY.png)
...
| 平台 | 接入指南 |
| --- | --- |
| 微信助理（推荐） | [查看指南](../../WeixinBot-Guide.md) |
| 微信客服号 | [查看指南](../../Wechat-Guide.md) |
| 企微助理 | [查看指南](../../Wecom-Guide.md) |
| QQ 机器人 | [查看指南](../../QQ-Guide.md) |
| 元宝机器人 | [查看指南](../../YuanBaoPai-Guide.md) |
| 飞书 | [查看指南](../../Feishu-Guide.md) |
| 钉钉机器人 | [查看指南](../../Dingtalk-Guide.md) |
...
1. 打开 WorkBuddy，点击左下角头像，打开 **设置 → 助理设置**；
   ...
   ![](https://www.codebuddy.cn/docs/static/assistant-1.C00zsyZs.png)
2. 按需配置对应平台的集成接入（微信/企业微信/QQ/钉钉/飞书）。

   ![](https://www.codebuddy.cn/docs/static/assistant-2.uE3_fGNm.png)
3. 按照提示完成配置。
...
| 平台 | 接入指南 |
| --- | --- |
| **微信助理** | [微信助理Bot 接入指南（推荐）](../../WeixinBot-Guide.md) |
| **微信客服号** | [微信服务号接入指南](../../Wechat-Guide.md) |
| **企微助理** | [WorkBuddy 接入企业微信指南](../../Wecom-Guide.md) |
| **QQ 机器人** | [WorkBuddy 接入 QQ 指南](../../QQ-Guide.md) |
| **元宝机器人** | [WorkBuddy 接入元宝派指南](../../YuanBaoPai-Guide.md) |
| **飞书** | [WorkBuddy 接入飞书指南](../../Feishu-Guide.md) |
| **钉钉机器人** | [WorkBuddy 接入钉钉指南](../../Dingtalk-Guide.md) |
