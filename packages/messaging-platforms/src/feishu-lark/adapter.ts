/**
 * FeishuLark platform adapter v1 surface.
 *
...
export const feishuLarkConfigSchema = z.object({
...
export type FeishuLarkConfig = z.infer<typeof feishuLarkConfigSchema>;

export class FeishuLarkAdapter implements PlatformAdapter {
  status: PlatformStatus = "idle";
  private config: FeishuLarkConfig;
  private messageCounter = 0;

  readonly platform = "feishu";

  constructor(config: FeishuLarkConfig) {
    this.config = feishuLarkConfigSchema.parse(config);
  }
