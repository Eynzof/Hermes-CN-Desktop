/**
 * SmsTwilio platform adapter v1 surface.
 *
...
export type SmsTwilioConfig = z.infer<typeof smsTwilioConfigSchema>;

export class SmsTwilioAdapter implements PlatformAdapter {
  ...
  constructor(config: SmsTwilioConfig) {
    this.config = smsTwilioConfigSchema.parse(config);
  }
