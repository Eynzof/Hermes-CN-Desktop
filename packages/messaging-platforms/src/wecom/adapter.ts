/**
 * WeCom platform adapter v1 surface.
 *
...
export class WeComAdapter implements PlatformAdapter {
  ...
  constructor(config: WeComConfig) {
    this.config = weComConfigSchema.parse(config);
  }
