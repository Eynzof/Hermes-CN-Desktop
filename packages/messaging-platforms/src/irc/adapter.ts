/**
 * Irc platform adapter v1 surface.
 *
...
export class IrcAdapter implements PlatformAdapter {
  ...
  constructor(config: IrcConfig) {
    this.config = ircConfigSchema.parse(config);
  }
