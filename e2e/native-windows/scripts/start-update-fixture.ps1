param(
  ...
  [string]$RuntimeArchive='C:\HermesV090Fixes\artifacts\hermes-agent-cn-runtime-win32-x64-0.21.0-cn.12.zip',
  [string]$RuntimeManifest='C:\HermesV090\Desktop App\bundled-runtime\stable-win32-x64.json',
  [string]$UiDist='C:\HermesV090Fixes\artifacts\desktop-0.9.0-ux12\web-dist',
