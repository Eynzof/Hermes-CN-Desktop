...
if(Get-NetTCPConnection -LocalPort 19446 -State Listen -ErrorAction SilentlyContinue){throw 'Shell update fixture port is occupied; inspect it before starting'}
