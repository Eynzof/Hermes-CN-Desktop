...
foreach($file in @('hindsight-fixture.json','openviking-fixture.json','ollama-fixture.json','local-model-fixture.json','local-vision-fixture.json','local-model-resource-adjustment.json','local-model-context-baseline.json','context-baseline-restoration.json','python-dependencies.txt','wander-fixture.json','wander-source-manifest.json','wander-python-dependencies.txt','wander-model-calls.ndjson')){
