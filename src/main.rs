    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::connection_auth::connection_auth_me,
              ...
              commands::mcp::mcp_oauth_apply,
              commands::mcp::mcp_server_trust,
            ...
            commands::context_files::read_context_files,
              ...
              commands::lsp::lsp_known_servers,
            ...
            commands::egress_proxy::egress_proxy_resolve_secret,
...
commands::memory_files::read_memory_files,
            ...
            commands::terminal_env::terminal_backends,
            commands::terminal_env::terminal_backend_status,
            ...
            commands::messaging::start_messaging_platform,
              ...
              commands::toolkit::tools_dispatch,
