...
> 当前版本是 `v0.6.12`。项目仍在快速迭代，API、打包流程、运行时分发策略和界面细节都可能继续调整。
...
- macOS Apple Silicon DMG：`Hermes-Huanxing-0.6.12_aarch64.dmg`
- macOS Intel DMG：`Hermes-Huanxing-0.6.12_x64.dmg`
- Windows x64 安装器：`Hermes-Huanxing-0.6.12_x64-setup.exe`
