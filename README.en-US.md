...
> Current release: `v0.6.11`. The project is still moving quickly. APIs, packaging, runtime distribution, and UI details may continue to change.
...
- macOS Apple Silicon DMG: `Hermes-Huanxing-0.6.11_aarch64.dmg`
- macOS Intel DMG: `Hermes-Huanxing-0.6.11_x64.dmg`
- Windows x64 installer: `Hermes-Huanxing-0.6.11_x64-setup.exe`
